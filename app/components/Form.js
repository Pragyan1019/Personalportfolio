...
<form action="" className='flex flex-col gap-3' onSubmit={saveform}>
  ...
  <input type="text" id='name' name='name' value={form.name} onChange={handlechange} placeholder='Enter your full name' className='p-1 outline-none bg-transparent'/>
  <label htmlFor="email">Email:</label>
  <input type="email" id='email' name='email' value={form.email} onChange={handlechange} placeholder='Enter your email' className='p-1 outline-none'/>
