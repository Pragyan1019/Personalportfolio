  ...
  return (
    <>
      <div className="relative project min-h-screen bg-black text-white bg-gradient-to-b from-white/30 to-transparent">
        <nav className="md:w-[70%] mx-auto px-3 flex  pb-2 text-xl md:text-2xl items-center md:justify-between">
       <Link href="/">    <motion.h1
            initial={{
              opacity: 0,
              y: 20,
          ...
          <motion.ul initial="hidden" animate="visible" className="flex gap-9">
            <Link href="/">
              ...
              <motion.li
                ...
                initial="hidden"
                animate="visible"
                className="font-semibold cursor-pointer hover:scale-120 transition-all ease-in-out"
              >
                Home
              </motion.li>
            </Link>
        ...
        <div className="bio md:mt-4 md:py-4 py-2">
          <div className="flex p-2 md:w-[65%] w-[95%]  mb-18  mx-auto md:flex-row flex-col">
            <div className="image md:w-[30%] w-[70%] mx-auto">
              <img src="nobg.png" alt="My image" className="md:w-70 " />
            </div>
            <div className="intro text-start md:w-[60%] flex flex-col items-center">
              <p className="mt-4 text-center md:text-3xl text-2xl md:mb-3 mb-1">
                <strong> Hello, I&apos;m Pragyan.</strong>
              </p>
              <p className="md:mt-1 text-center text-lg md:mb-3">
                <strong> Web Developer | Computer Science Student</strong>
              </p>
              <span className="mb-5  leading-relaxed">
                I&apos;ve always been a builder—first with LEGOs, now with code.
                I see web development as digital architecture, where every line
                of code is a brick in creating a beautiful and resilient
                structure. My focus is on building scalable applications that
                stand the test of time, for both the user and the next
                developer.
              </span>
          ...
          <div className="myphilosophy mb-10  text-center md:w-[65%] w-[95%] mx-auto ">
            <div className="text-center text-2xl mb-4  leading-relaxed">
              <strong>My Philosophy: Human-First Engineering</strong> <hr />
            </div>
            <div>
              I believe the best code is written for the people who will
              maintain it tomorrow. My focus is on creating clean, scalable, and
              well-documented systems that are as enjoyable to work with as they
              are for users to experience.
            </div>
          </div>
          <div className="mytoolbox mb-10  text-center">
            <h2 className="text-2xl mb-4">
              <strong>My Digital Toolkit</strong>
            </h2>
            <div className="flex-col md:w-[50%] w-[80%] mx-auto flex md:gap-10 gap-4">
              <div className="flex md:gap-0 gap-3 flex-wrap w-full mx-auto md:justify-around flex-col md:flex-row">
                <div className="js flex md:flex-col flex-row md:gap-0 gap-3 justify-center items-center transition-all ease-in-out duration-300 border border-teal-600 px-3 md:py-2 py-1 bg-none hover:scale-105  hover:shadow-yellow-500 shadow-sm hover:cursor-pointer rounded">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <div className="js flex md:flex-col flex-row md:gap-0 gap-3 justify-center items-center transition-all ease-in-out duration-300 border border-teal-600 px-3 md:py-2 py-1 bg-none hover:scale-105  hover:shadow-orange-600 shadow-sm hover:cursor-pointer rounded">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <div className="js p-3 flex md:flex-col flex-row md:gap-0 gap-3 justify-center items-center transition-all ease-in-out duration-300 border border-teal-600 px-3 md:py-2 py-1 bg-none hover:scale-105 hover:shadow-purple-600 shadow-sm hover:cursor-pointer rounded">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
              ...
              <div className="flex flex-wrap w-full mx-auto md:justify-evenly ml-1  md:gap-0 gap-3 flex-col md:flex-row">
                <div className="js  flex md:flex-col md:gap-0 gap-3 justify-center items-center transition-all ease-in-out duration-300 border border-teal-600 px-3 md:py-2 py-1bg-none hover:scale-105 hover:shadow-blue-500 shadow-sm hover:cursor-pointer rounded">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
                ...
                <div className="js  flex md:flex-col md:gap-0 gap-3 justify-center items-center transition-all ease-in-out duration-300 border border-teal-600 px-3 md:py-2 py-1bg-none hover:scale-105 hover:shadow-green-600 shadow-sm hover:cursor-pointer rounded">
                  <img src="mongo.png" alt="mongodb" width="66" height="66" />
                  <span>Mongo DB</span>
                </div>
                <div className="js  flex md:flex-col md:gap-0 gap-3 justify-center items-center transition-all ease-in-out duration-300 border border-teal-600 px-3 md:py-2 py-1bg-none hover:scale-105 hover:shadow-green-800 shadow-sm hover:cursor-pointer rounde">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
          ...
          <div className="myphilosophy mb-10  text-center md:w-[65%] w-[95%] mx-auto">
            <div className=" md:mb-4 mb-2 text-2xl  leading-relaxed">
              <strong>Beyond the Code</strong>{" "}
            </div>
            <div className="leading-relaxed">
              When I step away from the keyboard, you can find me analyzing the
              strategy on a chessboard or collaborating on a football pitch. I
              find the same principles of foresight, teamwork, and creative
              problem-solving apply to both coding and the games I love.
            </div>
          </div>
          <div className="text-center md:w-[65%] w-[95%] mx-auto">
